...
- 名稱：Mopsfin 台股財務
- 版本：${SERVER_VERSION}
- 說明：篩選台股研究候選，可選擇只替實際入選的最多 5 家 candidates 附上不影響分數的 current official catalyst snapshots，並查詢 TWSE／TPEx 上市櫃公司母體、官方原始日線、可稽核的 price-index-compatible 公司行動調整價格序列、歷史估值、月營收趨勢、benchmark reaction signals、重大訊息與法說會，以及 Mopsfin 財務比較 E 點通提供的公司財報與財務指標。
...
5. 連線後確認可以看到 ${TOOL_COUNT} 個唯讀工具，包含 screen_taiwan_stock_candidates、screen_taiwan_stock_candidates_with_catalyst_snapshots、get_stock_price_series、get_company_catalyst_events、get_company_catalyst_snapshots、get_monthly_revenue_trend、get_company_metrics_batch 與 get_stock_reaction_signals。
    ...
    <main>
      ...
      <section className="hero" id="top">
        ...
        <p className="lede">
          ...
          上市櫃公司母體、官方原始日線、可稽核的公司行動調整價格序列、歷史估值、月營收趨勢、市場反應代理、重大訊息與法說會、current official catalyst snapshots，並用透明四柱規則產生待深入研究的台股候選；需要時只替實際入選的最多 5 家 candidates 附上不影響分數的快照證據，再查詢 Mopsfin 提供的公司財報、批次指標、附註、產業與金融機構資料。
        </p>
