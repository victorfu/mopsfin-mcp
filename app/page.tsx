      ...
      <section className="notice" aria-labelledby="notice-title">
        ...
        <div>
          ...
          <div className="noticeContent">
            ...
            <p><code>get_company_catalyst_events</code> 依 selected company 與日期範圍即時查 MOPS 歷史重大訊息、法說會日曆，並用 TWSE／TPEx 每日重大訊息補強近期資料。<code>publishedAt</code>、<code>factDate</code>、<code>scheduledAt</code> 與 <code>effectiveAt</code> 分開；官方無事件、查詢失敗與 parser/security block 也分開。歷史事件的標題、地點、連結或備註更正會更新 fingerprint；分頁時須核對內容版本。它不提供分析師 consensus、預估修正、情緒分數或投資建議。</p>
