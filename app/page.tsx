      ...
      <section className="notice" aria-labelledby="notice-title">
        ...
        <div>
          ...
          <div className="noticeContent">
            ...
            <p>資料 freshness 依來源分開判讀：Mopsfin 財務資料依官方說明每日更新、可能較申報落後約一日；這不代表所有 TWSE／TPEx 資料固定落後一天。latest OHLC／估值與 completed-close dependencies 會以市場各自的官方年度開休市日曆、當月 exact benchmark session 及台北時間 13:33 guard 驗證 expected as-of；來源不可用、契約漂移或跨市場日期衝突時保守回 unknown，不猜測。月營收依資料年月與出表日，事件與 current snapshots 則依各自發布、事件或 snapshot 日期判讀。</p>
