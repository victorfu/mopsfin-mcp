...
export const analyzeObservedPriceTool = defineTool(
  ...
  async ({ company_code, observed_price_twd, observed_at, source_label }) => {
    try {
      ...
      const metaContract = observedPriceMetaContract(data);
      return success(
