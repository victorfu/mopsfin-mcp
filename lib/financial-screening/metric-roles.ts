...
export const FINANCIAL_SCREEN_METRIC_ROLE_DEFINITIONS = {
  ...
  loan_overdue_ratio: {
    ...
    acceptedCodes: ["NonPerformingLoansRatioLoans", "Fin01"],
    family: "fin",
    unitSemantic: "percent",
    applicableSectors: ["bank"],
  },
  loan_loss_reserve_coverage_ratio: {
    acceptedNames: ["放款業務備抵呆帳覆蓋率", "放款備抵呆帳覆蓋率"],
    acceptedCodes: ["CoverageRatioLoans", "Fin02"],
    family: "fin",
    unitSemantic: "percent",
    applicableSectors: ["bank"],
  },
  credit_card_overdue_ratio: {
    ...
    acceptedCodes: ["NonPerformingLoansRatioCreditCardService", "Fin03"],
    family: "fin",
    unitSemantic: "percent",
    applicableSectors: ["bank"],
  },
  credit_card_loss_reserve_coverage_ratio: {
    acceptedNames: ["信用卡應收帳款備抵呆帳覆蓋率", "信用卡備抵呆帳覆蓋率"],
    acceptedCodes: ["CoverageRatioCreditCardService", "Fin04"],
    family: "fin",
    unitSemantic: "percent",
    applicableSectors: ["bank"],
  },
  factoring_overdue_ratio: {
    ...
    acceptedCodes: [
      "NonPerformingLoansRatioAccountsReceivableFactoredWithoutRecourse",
      "Fin05",
    ],
    family: "fin",
    unitSemantic: "percent",
  ...
  factoring_loss_reserve_coverage_ratio: {
    ...
    acceptedCodes: [
      "CoverageRatioAccountsReceivableFactoredWithoutRecourse",
      "Fin06",
    ],
    family: "fin",
    unitSemantic: "percent",
  ...
  holding_capital_adequacy_ratio: {
    ...
    acceptedCodes: ["FinancialHoldingCapitalAdequacy", "HoldingCAR"],
    family: "adequacy",
    unitSemantic: "percent",
  ...
  bank_capital_adequacy_ratio: {
    ...
    acceptedCodes: ["BankCapitalAdequacy", "BankCAR"],
    family: "adequacy",
    unitSemantic: "percent",
    applicableSectors: ["bank"],
  },
  bills_capital_adequacy_ratio: {
    ...
    acceptedCodes: ["BillsFinanceCapitalAdequacy", "BillsCAR"],
    family: "adequacy",
    unitSemantic: "percent",
