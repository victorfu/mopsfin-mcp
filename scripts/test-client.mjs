...
const client = new Client({ name: "mopsfin-smoke-test", version: "0.4.1" });
...
try {
  ...
  if (server?.version !== "0.4.1") {
    throw new Error(`Expected server version 0.4.1, received ${server?.version ?? "unknown"}`);
  }
