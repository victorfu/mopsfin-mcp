...
const client = new Client({ name: "mopsfin-smoke-test", version: "0.6.2" });
...
try {
  ...
  if (server?.version !== "0.6.2") {
    throw new Error(`Expected server version 0.6.2, received ${server?.version ?? "unknown"}`);
  }
